...
![](https://img.xxsoftware.fun/github_setting.png)

![](https://img.xxsoftware.fun/github_discussions.png)

    4. 在完成以上步骤后，请前往 Giscus 页面open in new window 获得你的设置。

![](https://img.xxsoftware.fun/giscus.png)
...
![](https://img.xxsoftware.fun/blog_comments.png)
